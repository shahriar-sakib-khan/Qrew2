        ...
        headers: [
          {
            ...
            value: `default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data: https://lh3.googleusercontent.com https://*.r2.dev; connect-src 'self' http://localhost:3002 ${process.env.NEXT_PUBLIC_API_URL ? process.env.NEXT_PUBLIC_API_URL : ""} https://*.cloudflarestorage.com;`,
          },
          {
