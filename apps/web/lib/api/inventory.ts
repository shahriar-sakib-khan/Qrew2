...
export const brandsApi = {
  ...
  create: (data: any) => apiFetch<any>("/api/inventory/brands", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/brands/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const productCategoriesApi = {
  ...
  create: (data: any) => apiFetch<any>("/api/inventory/product-categories", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/product-categories/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  remove: (id: string) => apiFetch<any>(`/api/inventory/product-categories/${id}`, { method: "DELETE" }),
};
...
export const productsApi = {
  ...
  create: (data: any) => apiFetch<any>("/api/inventory/products", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/products/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const customersApi = {
  ...
  create: (data: any) => apiFetch<any>("/api/inventory/customers", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/customers/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const warehousesApi = {
  ...
  create: (data: any) => apiFetch<any>("/api/inventory/warehouses", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/warehouses/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const purchasesApi = {
  list: (status?: string) => apiFetch<any[]>(`/api/inventory/purchases${status ? `?status=${status}` : ""}`),
  getById: (id: string) => apiFetch<any>(`/api/inventory/purchases/${id}`),
  create: (data: any) => apiFetch<any>("/api/inventory/purchases", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/purchases/${id}`, { method: "PUT", body: JSON.stringify(data) }),
  remove: (id: string) => apiFetch<any>(`/api/inventory/purchases/${id}`, { method: "DELETE" }),
  // Status transitions — these write to the ledger.
  confirm: (id: string) => apiFetch<any>(`/api/inventory/purchases/${id}/confirm`, { method: "PATCH" }),
  cancel: (id: string) => apiFetch<any>(`/api/inventory/purchases/${id}/cancel`, { method: "PATCH" }),
};

// ─── Sales ────────────────────────────────────────────────────────────────────

export const salesApi = {
  list: (status?: string) => apiFetch<any[]>(`/api/inventory/sales${status ? `?status=${status}` : ""}`),
  getById: (id: string) => apiFetch<any>(`/api/inventory/sales/${id}`),
  create: (data: any) => apiFetch<any>("/api/inventory/sales", { method: "POST", body: JSON.stringify(data) }),
  update: (id: string, data: any) => apiFetch<any>(`/api/inventory/sales/${id}`, { method: "PUT", body: JSON.stringify(data) }),
...
export const inventoryApi = {
  ...
  getTransactions: (params?: { productId?: string; warehouseId?: string; transactionType?: string; page?: number; limit?: number }) => {
    const qs = new URLSearchParams();
    ...
    return apiFetch<{ data: any[]; page: number; limit: number }>(`/api/inventory/transactions?${qs}`);
  },
...
export const returnsApi = {
  ...
  createPurchaseReturn: (data: any) =>
    apiFetch<any>("/api/inventory/returns/purchase", { method: "POST", body: JSON.stringify(data) }),
};
