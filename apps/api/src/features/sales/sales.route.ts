...
salesRouter.patch('/:id/confirm', requireOrgPermission('inventory:confirm_sale'), SalesController.confirm);
salesRouter.patch('/:id/cancel', requireOrgPermission('inventory:cancel_sale'), SalesController.cancel);
