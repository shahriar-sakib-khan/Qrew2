...
vi.mock("@starter/db", () => {
  ...
  return {
    ...
    templateHeaderFields: { id: "templateHeaderFields" },
    invoiceDocumentSequences: { id: "invoiceDocumentSequences", organizationId: "organizationId", currentValue: "currentValue" },
