  ...
  static async hydrateFromTemplate(
    ...
    for (const th of tHeaders) {
      ...
      if (project) {
        ...
        else if (th.fileFieldKey === "name" || th.fileFieldKey === "status")
          val = project[th.fileFieldKey] || "";
        else if (th.fileFieldKey && project.customFields)
          val = (project.customFields as any)[th.fileFieldKey] || "";
      }
